    ...
    <div className="h-screen flex flex-col items-center justify-start p-10">
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden transition-shadow">
        ...
        <div className="p-4">
          ...
          <p className="text-gray-600 mb-4">
          At IMDB clone, we understand the passion and excitement that surrounds the world of movies and television. Whether you're a casual viewer looking for your next binge-worthy series or a dedicated cinephile seeking hidden gems, our platform has something for everyone. From classic films to the latest releases, we strive to curate a diverse collection of content that caters to every taste and preference.
          </p>
          <p className="text-gray-600 mb-4">
          ...
          Join us on our journey to celebrate the magic of cinema and television. Whether you're a lifelong movie aficionado or just beginning your exploration, IMDB clone is here to guide you on your cinematic adventure. Let's discover, share, and celebrate the art of storytelling together.
          </p>
        </div>
      </div>
    </div>
